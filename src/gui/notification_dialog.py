...
def suppress_focus_errors():
    """Suppress common Tkinter focus errors."""
    import tkinter as tk
...
class BillNotificationDialog(ctk.CTkToplevel):
    ...
    Shows bill information and provides quick actions.
    """
    ...
    def _safe_focus(self):
        """Safely focus and lift the window."""
        try:
    ...
    def _setup_header(self):
        """Setup the header section with urgency indicator."""
    ...
    def _setup_message(self):
        """Setup the main message section."""
    ...
    def _setup_details(self):
        """Setup the bill details section."""
    ...
    def _open_email(self):
        """Open default email client with company email."""
        try:
            company_email = self.notification_data.get('company_email')
            if company_email:
                try:
    ...
    def _auto_close(self):
        """Auto-close the notification after timeout."""
        if self._destroyed:
            return
...
class NotificationManager:
    ...
    def show_notification(self, notification_data: Dict, on_mark_paid: Optional[Callable] = None, on_snooze: Optional[Callable] = None):
        """
        Show a new notification dialog.
